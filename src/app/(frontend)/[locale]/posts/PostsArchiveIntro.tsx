...
export function PostsArchiveIntro({ locale, title }: PostsArchiveIntroProps) {
  ...
  return (
    <section className="posts-archive-intro relative isolate overflow-hidden bg-white text-slate-950 dark:bg-black dark:text-white">
      ...
      <div className="home-atmosphere home-atmosphere-drift-a pointer-events-none absolute -left-[18%] top-[4%] h-[38rem] w-[38rem] rounded-full bg-[radial-gradient(circle,rgba(255,143,114,0.05),transparent_72%)] opacity-36 dark:bg-[radial-gradient(circle,rgba(255,143,114,0.055),transparent_72%)] dark:opacity-45" />

      <div className="home-atmosphere home-atmosphere-drift-b pointer-events-none absolute right-[-20%] top-[10%] h-[40rem] w-[40rem] rounded-full bg-[radial-gradient(circle,rgba(125,215,255,0.065),transparent_72%)] opacity-34 dark:bg-[radial-gradient(circle,rgba(125,215,255,0.06),transparent_74%)] dark:opacity-42" />

      <div className="pointer-events-none absolute inset-x-[10%] top-[28%] h-[10rem] bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.38),transparent_74%)] opacity-68 blur-[48px] dark:bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.02),transparent_74%)] dark:opacity-65" />
      ...
      <div className="container relative z-10 pb-14 pt-16 sm:pb-16 sm:pt-20 lg:pb-20 lg:pt-24">
