...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  if (!src && resource && typeof resource === 'object') {
    ...
    const preferredSize = resourceSize ? resource.sizes?.[resourceSize] : undefined
    const preferredUrl = preferredSize?.url || url

    width = preferredSize?.width || fullWidth || undefined
    height = preferredSize?.height || fullHeight || undefined
    alt = altFromResource || ''

    const cacheTag = resource.updatedAt

    src = getMediaUrl(preferredUrl, cacheTag)
  }
