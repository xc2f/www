...
export interface Config {
  ...
  jobs: {
    tasks: {
      ...
      backupDatabase: TaskBackupDatabase;
...
export interface Moment {
  id: number;
  title?: string | null;
  mood?: ('happy' | 'calm' | 'thoughtful' | 'tired' | 'sad' | 'energized' | 'content' | 'neutral') | null;
  images?:
    | {
        image?: (number | null) | Media;
        id?: string | null;
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'send-email' | 'backupDatabase' | 'schedulePublish';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'send-email' | 'backupDatabase' | 'schedulePublish') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskBackupDatabase".
 */
export interface TaskBackupDatabase {
  input?: unknown;
  output?: unknown;
}
/**
